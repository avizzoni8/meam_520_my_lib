...
class PlanarIK:
    ...
    def rrr_abstract_ik(self, target):
        ...
        q2_a=-abs(acos((pow(x2,2)+pow(y2,2)-pow(a1,2)-pow(a2,2))/(2*a1*a2)))
        q2_b=-q2_a
        
        q1_a=atan2(y2, x2)-atan2(a2*sin(q2_a), a1+a2*cos(q2_a))
        q1_b=atan2(y2, x2)-atan2(a2*sin(q2_b), a1+a2*cos(q2_b))
